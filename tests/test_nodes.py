...
class TestMultiPass:
	def test_node_exists(self):
		from src_python.nodes.multi_pass import PT_MultiPass
...
class TestConditioning:
	def test_node_exists(self):
		from src_python.nodes.conditioning import PT_Conditioning
...
class TestDynamicPassthrough:
	def test_node_exists(self):
		from src_python.nodes.dynamic_passthrough import PT_DynamicPassthrough
...
class TestDynamicBus:
	def test_node_exists(self):
		from src_python.nodes.dynamic_bus import PT_DynamicBus
...
class TestDynamicSingle:
	def test_node_exists(self):
		from src_python.nodes.dynamic_single import PT_DynamicSingle
