...
class TestMultiPass:
	def test_node_exists(self):
		from py.nodes.multi_pass import PT_MultiPass
...
class TestConditioning:
	def test_node_exists(self):
		from py.nodes.conditioning import PT_Conditioning
...
class TestDynamicPassthrough:
	def test_node_exists(self):
		from py.nodes.dynamic_passthrough import PT_DynamicPassthrough
...
class TestDynamicBus:
	def test_node_exists(self):
		from py.nodes.dynamic_bus import PT_DynamicBus
	...
	def test_creates_bus_dict(self):
		...
		assert "INPUT" in bus
		assert "INPUT_2" in bus


class TestDynamicSingle:
	def test_node_exists(self):
		from py.nodes.dynamic_single import PT_DynamicSingle
