...
class TestTypes:
	def test_comfy_types_defined(self):
		from py.config.types import COMFY_TYPES
	...
	def test_type_specs_defined(self):
		from py.config.types import TYPE_SPECS
	...
	def test_force_input_types(self):
		from py.config.types import FORCE_INPUT_TYPES
	...
	def test_batchable_types(self):
		from py.config.types import BATCHABLE_TYPES
...
class TestCategories:
	def test_main_category_defined(self):
		from py.config.categories import MAIN_CATEGORY
		assert MAIN_CATEGORY == "Tojioo Passthrough"

	def test_categories_defined(self):
		from py.config.categories import CATEGORIES
