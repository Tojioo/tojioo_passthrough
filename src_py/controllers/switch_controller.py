...
class SwitchController:
	...
	BATCH_SWITCH_SPECS = [
		...
		("PT_AnyConditioningBatchSwitch", "conditioning", "cond", "conditioning", "Any Conditioning Batch Switch"),
	]
	...
	@staticmethod
	def _make_switch(class_name: str, type_key: str, input_prefix: str,
	...
	@staticmethod
	def _make_batch_switch(class_name: str, type_key: str, input_prefix: str,
		output_name: str, display_name: str):
		type_name = COMFY_TYPES[type_key]
